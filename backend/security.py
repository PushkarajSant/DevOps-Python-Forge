...
SECRET_KEY = os.getenv("SECRET_KEY", "devops-forge-super-secret-key-change-in-prod")
ALGORITHM = "HS256"
...
async def get_current_user_ws(websocket: WebSocket, db: Session) -> Optional[models.User]:
